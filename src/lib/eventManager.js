import {reactNamesToTopLevelEvents, topLevelEventsToReactNames} from "./DomEventProperties.js";
...
export function setupEventListeners(root) {
    ...
    eventMap.forEach((handlers, eventType) => {
        rootElement.addEventListener(reactNamesToTopLevelEvents.get(eventType), handleEvent, true);
    })
}
...
export function removeEvent(element, eventType, handler) {
    ...
    eventMap.set(eventType, handlers.filter(({ element: el, handler: h }) => el !== element || h !== handler));
}
