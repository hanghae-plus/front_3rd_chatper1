  ...
  return `
      ...
      <div class="bg-white rounded-lg shadow p-4 mb-4">
        ...
        <div class="mt-2 flex justify-between text-gray-500">
          <span class="like-button" data-post-id="1">좋아요</span>
          <span>댓글</span>
          <span>공유</span>
        </div>
      </div>
      <div class="bg-white rounded-lg shadow p-4 mb-4">
        ...
        <div class="mt-2 flex justify-between text-gray-500">
          <span class="like-button" data-post-id="2">좋아요</span>
          <span>댓글</span>
          <span>공유</span>
        </div>
      </div>
      <div class="bg-white rounded-lg shadow p-4 mb-4">
        ...
        <div class="mt-2 flex justify-between text-gray-500">
          <span class="like-button" data-post-id="3">좋아요</span>
          <span>댓글</span>
          <span>공유</span>
        </div>
      </div>
      <div class="bg-white rounded-lg shadow p-4 mb-4">
        ...
        <div class="mt-2 flex justify-between text-gray-500">
          <span class="like-button" data-post-id="4">좋아요</span>
          <span>댓글</span>
          <span>공유</span>
        </div>
      </div>
      <div class="bg-white rounded-lg shadow p-4 mb-4">
        ...
        <div class="mt-2 flex justify-between text-gray-500">
          <span class="like-button" data-post-id="5">좋아요</span>
          <span>댓글</span>
          <span>공유</span>
        </div>
      </div>
