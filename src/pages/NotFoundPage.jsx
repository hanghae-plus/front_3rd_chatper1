...
export const NotFoundPage = () => {
    ...
    return <main className="bg-gray-100 flex items-center justify-center min-h-screen">
        <div className="bg-white p-8 rounded-lg shadow-md w-full text-center" style="max-width: 480px">
            ...
            <a href="/" data-link={true} className="bg-blue-600 text-white px-4 py-2 rounded font-bold">홈으로 돌아가기</a>
        </div>
    </main>
};
