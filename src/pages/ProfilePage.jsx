            ...
            <div className="max-w-md w-full">
                ...
                <main className="p-4">
                    ...
                    <form id="profile-form" onSubmit={updateProfile}>
                        ...
                        <input type="text" id="username" name="username" value={username} className="w-full p-2 border rounded" />
                        </div>
                        <div className="mb-4">
                        <label for="email" className="block text-gray-700 text-sm font-bold mb-2">이메일</label>
                        <input type="email" id="email" name="email" value={email} className="w-full p-2 border rounded" />
                        </div>
                        <div className="mb-6">
